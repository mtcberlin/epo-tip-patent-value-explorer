...
In the radar chart the indicators are grouped into two EPO dimensions, **Technological Importance** and **Market Relevance**, mirroring the OECD paper's framing ("Indicators of Technological and Economic Value").
